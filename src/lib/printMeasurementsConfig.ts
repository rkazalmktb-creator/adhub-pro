...
import { PrintConfig, createDefaultPrintConfig } from './printMeasurementsTypes';
...
export const createMeasurementsConfigFromSettings = (settings: Partial<PrintSettings>): PrintConfig => {
  ...
  // ✅ Header style/layout from settings
  (config.header as any).headerStyle = settings.header_style || 'classic';
