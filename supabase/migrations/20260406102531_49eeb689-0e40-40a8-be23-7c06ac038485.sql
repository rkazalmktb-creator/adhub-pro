...
-- ربط الفرق بالشركات الصديقة
UPDATE installation_teams SET friend_company_ids = ARRAY['c9a8c5c5-e47e-44d9-bcb8-7ab7431c4f74'::uuid] WHERE team_name = 'دانة مصراتة';
UPDATE installation_teams SET friend_company_ids = ARRAY['8549c172-f485-4374-ab66-155b02c82975'::uuid] WHERE team_name = 'اثر مصراتة';
UPDATE installation_teams SET friend_company_ids = ARRAY['523cca2d-7cf1-49e1-a3a0-f2c0488b93d1'::uuid] WHERE team_name LIKE '%الأصدقاء%';

-- تحديث trigger التوزيع بمنطق الشركة أولاً
